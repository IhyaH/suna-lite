...
Suna-Lite 是一个轻量级的AIAgent系统，基于OpenAI API构建，提供了文件操作、命令行执行、Web搜索和浏览器自动化等核心功能。该项目采用模块化设计，使用Python异步编程模式，具有完善的工具系统和安全机制。
...
- **对话测试**: `tests/test_conversation.py` - 测试AIAgent对话能力
